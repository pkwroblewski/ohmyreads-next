...
| 2026-09-08 | 5 | ✅ Complete | Lint/typecheck/711 tests/build green; production DPR-2: `/books` 17/20 ≥ 2×, `/trending` 24/24, Open Library replacements 2.22×, Google rescues 2.0×, Talons of Power 1.15× (accepted), null-cover row renders the Open Library scan; committed as `4452161`, Vercel `dpl_HMgZsWQfgzaHysZ65oJ8fY9Sb13o` READY on ohmyreads-next.vercel.app. |
