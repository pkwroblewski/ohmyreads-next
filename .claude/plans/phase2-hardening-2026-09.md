...
| 24 | Migration 067: RLS initplan rewrite, merge permissive policies, drop redundant indexes/table, search_path on 4 functions | 🟡 Medium | Medium | [ ] PENDING | `supabase/migrations/067_rls_performance.sql` |
| 25 | Final QA incl. signed-in admin + user smoke test | - | Medium | [ ] PENDING | - |

**Progress: 8/25 complete**
...
## Task 24: Migration 067 — RLS performance and catalog cleanup

**Source:** Audit Findings > D7, D8 (live Supabase performance advisor 2026-09-01)  
**Priority:** 🟡 Medium  
**Effort:** Medium  
**File(s):** `supabase/migrations/067_rls_performance.sql`
